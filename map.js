mapboxgl.accessToken = 'pk.eyJ1IjoiamNvbGxpbnN1Y3NkIiwiYSI6ImNtYXI5eXR1dDA4eWwybW9nM3RnMWh5b2QifQ.fjpmAMpLpqIKgnptrZP3Mg';
...
map.on('load', () => {
    map.addSource('boston_route', {
        type: 'geojson',
        data: './data/bikes1.geojson'
    });

    map.addSource('cambridge_route', {
        type: 'geojson',
        data: './data/bikes2.geojson'
    });
